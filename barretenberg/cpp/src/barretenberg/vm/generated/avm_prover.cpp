...
void AvmProver::execute_wire_commitments_round()
{
    ...
    witness_commitments.poseidon2_a_0 = commitment_key->commit(key->poseidon2_a_0);
    witness_commitments.poseidon2_a_1 = commitment_key->commit(key->poseidon2_a_1);
    witness_commitments.poseidon2_a_2 = commitment_key->commit(key->poseidon2_a_2);
    witness_commitments.poseidon2_a_3 = commitment_key->commit(key->poseidon2_a_3);
    witness_commitments.poseidon2_b_0 = commitment_key->commit(key->poseidon2_b_0);
    witness_commitments.poseidon2_b_1 = commitment_key->commit(key->poseidon2_b_1);
    witness_commitments.poseidon2_b_2 = commitment_key->commit(key->poseidon2_b_2);
    witness_commitments.poseidon2_b_3 = commitment_key->commit(key->poseidon2_b_3);
    ...
    transcript->send_to_verifier(commitment_labels.poseidon2_a_0, witness_commitments.poseidon2_a_0);
    transcript->send_to_verifier(commitment_labels.poseidon2_a_1, witness_commitments.poseidon2_a_1);
    transcript->send_to_verifier(commitment_labels.poseidon2_a_2, witness_commitments.poseidon2_a_2);
    transcript->send_to_verifier(commitment_labels.poseidon2_a_3, witness_commitments.poseidon2_a_3);
    transcript->send_to_verifier(commitment_labels.poseidon2_b_0, witness_commitments.poseidon2_b_0);
    transcript->send_to_verifier(commitment_labels.poseidon2_b_1, witness_commitments.poseidon2_b_1);
    transcript->send_to_verifier(commitment_labels.poseidon2_b_2, witness_commitments.poseidon2_b_2);
    transcript->send_to_verifier(commitment_labels.poseidon2_b_3, witness_commitments.poseidon2_b_3);
